        ...
        <div className="grid md:grid-cols-[0.9fr_1.1fr] gap-6 mb-16">
          ...
          >
            ...
            <div className="p-6 md:p-8">
              <h3 className="text-xl md:text-2xl font-bold mb-4 md:mb-6">{featuredArticle.title}</h3>
              <div className="flex items-center gap-3 md:gap-4">
                ...
                <div>
                  <div className="font-bold text-base md:text-lg text-[#0B0B0B]">{featuredArticle.author}</div>
                  <div className="text-sm md:text-base text-gray-600">{featuredArticle.date}</div>
                </div>
              </div>
            </div>
          </a>
              ...
              >
                <div className="flex flex-col sm:flex-row">
                  ...
                  <div className="p-6 md:p-10 flex flex-col justify-center">
                    <h3 className="text-lg md:text-2xl font-bold mb-3 md:mb-4">{article.title}</h3>
                    <p className="text-gray-600 text-sm md:text-lg leading-relaxed">{article.excerpt}</p>
                  </div>
                </div>
              </a>
            ))}
