  ...
  const experiences = [
    {
      ...
      title: "AI Product Manager — The Data Island",
      description:
    ...
    },
    {
      ...
      title: "Business Analyst — The Data Island",
      description:
        "Translated client requirements into SRS and functional specs, delivered data-driven insights from operational datasets, and supported pre-sales and post-sales activities.",
      icon: "/images/company.png",
    },
    {
      period: "Jan 2024 - Dec 2025",
      title: "Student Worker — NSU Public Relations Office",
      description:
        "Maintained administrative documentation, analyzed operational datasets for performance trends, and coordinated media production for university events.",
